...
# print(respsonse.status_code)
# print(respsonse.text)
# respsonse = s.get(link + '/advert/13')
# print(respsonse.status_code)
# print(respsonse.text)
# respsonse = requests.patch(link + '/advert/9', json={'description': 'new_desc'})
# print(respsonse.status_code)
# print(respsonse.text)
# respsonse = requests.get(link + '/advert/9')
# print(respsonse.status_code)
# print(respsonse.text)
# respsonse = s.delete(link + '/advert/13')
# print(respsonse.status_code)
# print(respsonse.text)
respsonse = requests.get(link + '/advert/10')
print(respsonse.status_code)
print(respsonse.text)
